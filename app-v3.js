...
(function(){
 ...
 fileInput.addEventListener("change", async function(){
   ...
   try{
     ...
     console.error(e);
     status.textContent=f.name+" • read failed";
   }
 });
 btn.addEventListener("click",function(){ if(screenplayText) analyzeScreenplay(); else alert("The screenplay could not be read. Please reselect the DOCX file.");});
})();
